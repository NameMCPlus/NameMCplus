...
function betterNameMC(username) {
  ...
  try {
    const resultsElement = document.querySelector("#status-bar").parentElement.parentElement.parentElement.getElementsByTagName("h6")[1].innerText;
    if (resultsElement.includes("Profiles")) {
